...
nswebModule.service('PlayerConfig', function () {
	'use strict';
...
nswebModule.factory('RegisteredPlayers', [ 'PlayerConfig', function (PlayerConfig) {
	'use strict';
    var configurations = {
        youtube: {
            options: {
...
nswebModule.directive('embedVideo', [ function ($filter, RegisteredPlayers) {
	'use strict';
    return {
        restrict: "A",
          template: '<object width="590" height="320">' +
              '<param name="movie" value="{{config.videoUrl}}"></param>' +
              '<param name="allowFullScreen" value="true"></param>' +
              '<param name="allowscriptaccess" value="always"></param>' +
              '<embed ng-src="{{config.videoUrl}}" type="application/x-shockwave-flash" allowscriptaccess="always" allowfullscreen="true" width="590" height="320" wmode="transparent"></embed>' +
              '</object>',
...
nswebModule.filter('videoOptions', function () {
	'use strict';
...
nswebModule.filter('whitelist', function () {
	'use strict';
